...
def compute_jaccard(each_bin, num_bins, start_time_local):
    ...
    for bucket_id in each_bin:
        ...
        remove_urls_list_sub, deduped_local_sub, counter_local_sub = url_pairs_to_remove(
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--save-fingerprints', type=str, default=None, help='Save the fingerprints of the inputs.'
    )
    parser.add_argument(
        '--output',
        type=str,
