...
def orqa(Dataset):
    ...
    def cross_entropy_loss_func(query_tokens, context_tokens, output_tensor):
        ...
        return loss, {'lm loss': reduced_loss[0], 'correct_prediction_count': reduced_loss[1]}
    ...
    def train_valid_datasets_provider():
        ...
        train_dataset = Dataset(
            'training', args.train_data, tokenizer, args.retriever_seq_length, evaluate=False
        )
        valid_dataset = Dataset(
            'validation', args.valid_data, tokenizer, args.retriever_seq_length, evaluate=True
        )
