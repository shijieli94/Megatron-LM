...
def validate_args(args, defaults={}):
    ...
    if args.pipeline_model_parallel_size > 1:
        if args.pipeline_model_parallel_split_rank is not None:
            assert (
                args.pipeline_model_parallel_split_rank < args.pipeline_model_parallel_size
            ), 'split rank needs' ' to be less than pipeline model parallel size ({})'.format(
                args.pipeline_model_parallel_size
            )
...
def _add_training_args(parser):
    ...
    group.add_argument(
        '--profile-step-start', type=int, default=10, help='Gloable step to start profiling.'
    )
    group.add_argument(
        '--profile-step-end', type=int, default=12, help='Gloable step to stop profiling.'
    )
    group.add_argument(
    ...
    group.add_argument(
        '--expert-parallel', action='store_true', help='Enable expert parallel optimization.'
    )
